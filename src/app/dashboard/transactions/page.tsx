...
export default function TransactionsPage() {
  ...
  const isLoading = transactionsLoading || categoriesLoading || creditCardsLoading;
  
  if (isLoading) {
    return <div className="flex items-center justify-center h-full"><Loader2 className="h-8 w-8 animate-spin" /></div>
  }

  return <TransactionsClient initialTransactions={transactions} categories={categories} creditCards={creditCards} />;
}
