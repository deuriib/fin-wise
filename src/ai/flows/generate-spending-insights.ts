...
const prompt = ai.definePrompt({
  ...
  prompt: `You are a personal finance advisor. Analyze the user's income, expenses, and budget, and provide personalized insights and recommendations to help them better manage their finances.
